...
public class DeliveryManWorkAreaJPanel extends javax.swing.JPanel {
  ...
  if(order.getDeliveryManName()!=null && order.getDeliveryManName().equals(userAccount.getEmployee().getName())){
    ...
    private void initComponents() {
        ...
        processJButton.setText("Order Delivery Status");
        processJButton.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                processJButtonActionPerformed(evt);
            }
        });
        add(processJButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 279, -1, 50));
        ...
        add(refreshJButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(915, 40, 90, 40));
        ...
        add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(108, 58, 770, 180));
    ...
    private void processJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_processJButtonActionPerformed
        ...
        order1.setStatus("order delivered");
            ...
            JOptionPane.showMessageDialog(null, "This order has been is delivered successfully");
