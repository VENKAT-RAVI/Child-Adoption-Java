...
public class TrackOrderJPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        orderHistoryTable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Order Id", "Customer Name", "Customer's Message", "Status", "Restaurant Name"
            }
        ) {
        ...
        add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 330, 760, 96));
        ...
        add(cancelBtn, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 210, 130, 50));
        ...
        add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(330, 50, 170, -1));
        ...
        add(jScrollPane2, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 100, 770, 96));

        jLabel2.setFont(new java.awt.Font("Times New Roman", 1, 24)); // NOI18N
        jLabel2.setText("Order history");
        add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(330, 290, -1, -1));
        ...
        add(feedbackBtn, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 460, -1, -1));
        add(feedbackTxt, new org.netbeans.lib.awtextra.AbsoluteConstraints(320, 450, 410, 40));

        ConfirmOrderBtn.setText("Recieved");
        ConfirmOrderBtn.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                ConfirmOrderBtnActionPerformed(evt);
            }
        });
        add(ConfirmOrderBtn, new org.netbeans.lib.awtextra.AbsoluteConstraints(400, 210, 150, 50));
    ...
    private void feedbackBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_feedbackBtnActionPerformed
       ...
       /* if(o.getFeedback().equals("")||o.getFeedback()==null){
        ...
        JOptionPane.showMessageDialog(null, "Feedback cannot be empty Please fill the Feedback Section");
            return;
        }
