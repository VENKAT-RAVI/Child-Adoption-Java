...
public class AdminCreateScreen extends javax.swing.JPanel {
    ...
    private void btnCreateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCreateActionPerformed
        ...
        {            
            txtPword.setBorder(BorderFactory.createLineBorder(Color.RED));
            jLabel2.setForeground(Color.RED);
            JOptionPane.showMessageDialog(null, "Password should be atleast 6 digits and a combination of number,uppercase letter,lower case letter and a special character $*#&");
            return;
        }
        ...
        {
            Date d =new Date();
            admin.getCustDir().getCustomerList().add(new Customer(password,username,d));
            JOptionPane.showMessageDialog(null, "Customer login  successfull");
        ...
        if(radioSupplier.isSelected())
        {
            ...
            JOptionPane.showMessageDialog(null, "Supplier login successfull");
    ...
    private void radioCustomerActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_radioCustomerActionPerformed
        if (radioCustomer.isSelected() == true) {
            radioSupplier.setEnabled(false);
        }
    ...
    private void radioSupplierActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_radioSupplierActionPerformed
        if (radioSupplier.isSelected() == true) {
            radioCustomer.setEnabled(false);
        }
